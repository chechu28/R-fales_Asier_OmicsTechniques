...
#TARGETS
targets <-read.csv("~/Documentos/uni/2n/3r_trimestre/omics techniques/2nd_part/lab2/class_exercise/GSE27174_RAW/targets.csv", header = TRUE, sep=";") 
targets
...
rawData <- read.celfiles("~/Documentos/uni/2n/3r_trimestre/omics techniques/2nd_part/lab2/class_exercise/GSE27174_RAW/GSM671653.CEL")
